  ...
  return (
    <div className="max-w-4xl mx-auto mt-6 space-y-6">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-zinc-200 dark:border-slate-800">
        <div>
          <h1 className="text-xl font-bold text-zinc-800 dark:text-slate-100">{t.scan.title}</h1>
          <p className="text-xs text-zinc-500 dark:text-slate-500 font-mono mt-0.5">{scanId}</p>
        </div>
        {isCompleted && (
      ...
      {/* Progress Section */}
      <div className="bg-white dark:bg-slate-900 border border-zinc-200 dark:border-slate-800 rounded-lg p-6 shadow-sm space-y-4 transition-colors duration-300">
      ...
      {/* Legend */}
      <div className="flex flex-wrap gap-4 text-xs text-zinc-500 dark:text-slate-400">
